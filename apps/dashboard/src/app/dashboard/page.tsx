...
export default function DashboardPage() {
  ...
  const buckets: UsageChartResponse['buckets'] = useMemo(() => chartData?.buckets ?? [], [chartData?.buckets])
    ...
    <DashboardLayout>
      <div className="flex items-center justify-center h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <a href={process.env.NEXT_PUBLIC_DOCS_URL || "http://localhost:3002"} target="_blank" rel="noopener noreferrer" className="inline-block bg-gradient-to-br from-[#ffba38] to-[#c78b00] text-[#281900] px-6 py-2 rounded-md font-medium hover:shadow-[0_0_20px_rgba(255,186,56,0.3)] transition-all">View Docs</a>
        </div>
      </div>
    </DashboardLayout>
  )
  ...
  return (
    <DashboardLayout>
      ...
      {/* Metric Cards */}
      <MetricCards metrics={metrics} trends={trends as any} comparisonText={comparisonText} />
